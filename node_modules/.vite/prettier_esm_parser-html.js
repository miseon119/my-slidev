...
!function(e4, t2) {
  ...
  function n2() {
    return typeof WeakMap != "undefined" ? /* @__PURE__ */ new WeakMap() : { add: r2, delete: r2, get: r2, set: r2, has: function(e5) {
      return false;
    } };
  }
...
var bc = /* @__PURE__ */ new Set(["template", "style", "script"]);
function Sc(e4, t2) {
    ...
    visit(e5) {
      ((e6) => {
        ...
        if (e6.type === "element" && (!s2 || e6.namespace && e6.namespace !== e6.tagDefinition.implicitNamespacePrefix && !kl(e6) || (e6.name = E2(e6.name, (e7) => e7 in wl)), o2)) {
          const t2 = Fl[e6.name] || /* @__PURE__ */ Object.create(null);
